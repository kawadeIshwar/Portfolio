            ...
            <a 
              ...
              className={`group w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-pink-500/25 cursor-pointer relative z-10 ${
                dark 
                  ...
                  : 'bg-gray-100 hover:bg-gradient-to-r hover:from-pink-100 hover:to-purple-100'
              }`}
            >
            ...
            <a 
              ...
              className={`group w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/25 cursor-pointer relative z-10 ${
                dark 
                  ...
                  : 'bg-gray-100 hover:bg-gradient-to-r hover:from-blue-100 hover:to-cyan-100'
              }`}
            >
              <svg className={`w-6 h-6 transition-colors duration-300 ${
                dark 
            ...
            <a 
              ...
              className={`group w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-gray-500/25 cursor-pointer relative z-10 ${
                dark 
                  ...
                  : 'bg-gray-100 hover:bg-gradient-to-r hover:from-gray-100 hover:to-slate-100'
              }`}
            >
              <svg className={`w-6 h-6 transition-colors duration-300 ${
                dark 
